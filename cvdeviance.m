...
y = y(s.timeBins);
yhat = yhat(s.timeBins,:);  % todo: check that this indexing is correct // i added this on 210202 // why did it work before i added this???
...
t1(y==0) = 0;
t2 = y - yhat;
devFull = 2*nansum(t1-t2)';  % todo: should i need nansum here?

% null model deviance
t1 = y .* (log(y) - log(null));
t1(y==0) = 0;
t2 = y - null;
devNull = 2*nansum(t1-t2)';  % todo: should i need nansum here?
